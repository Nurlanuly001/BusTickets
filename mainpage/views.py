...
class SignUp(generic.CreateView):
    ...
    success_url = reverse_lazy('login')  #after registration it reditrects to login page
    template_name = 'signup.html'

def home(request):
    return render(request,'page1.html')  #shows first page where you will search necessary buses with time
...
def buses(request):
    ...
    if 'from_name' and 'to_name' and 'dr' in request.GET:
        ...
        return render(request, 'page2.html', {'buses': buses,'message1':message1,'message2':message2,'message3':message3,'quantity':s,'dates':dates})  #data processing
